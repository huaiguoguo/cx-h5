    ...
    methods: {
        ...
        countDown() {
            if (!this.timer) {
                ...
                if (
                    this.$store.state.user.twoLevelCipherEndTimestamp - 60 <
                    currentTimeStamp
                ) {
                    this.$store.commit(
                        'user/setTwoLevelCipherEndTimestamp',
                        currentTimeStamp + 60
                    )
                }
                ...
                this.timer = setInterval(() => {
                    ...
                    const text =
                        this.$store.state.user.twoLevelCipherEndTimestamp -
                        currentTimeStampBa +
                        '秒后重发'
                    if (
                        this.$store.state.user.twoLevelCipherEndTimestamp >
                            currentTimeStampBa &&
                        this.$store.state.user.twoLevelCipherEndTimestamp > 0
                    ) {
                        ...
                        this.$store.commit('user/setTwoLevelCipherEndTimestamp', 0)
                    }
                }, 1000)
            }
        },
